...
DEVICE_BUS = 1
DEVICE_ADDR = 0x77 # (119)
bus = smbus.SMBus( DEVICE_BUS )

def reader( ):

	# BMP180 address, DEVICE_ADDR(119)
	# Read data back from 0xAA(170), 22 bytes
	data = bus.read_i2c_block_data(DEVICE_ADDR, 0xAA, 22)
	...
	# temp MSB, temp LSB
	data = bus.read_i2c_block_data(DEVICE_ADDR, 0xF6, 2)
	...
	bus.write_byte_data(DEVICE_ADDR, 0xF4, 0x74)
	...
	data = bus.read_i2c_block_data(DEVICE_ADDR, 0xF6, 3)
