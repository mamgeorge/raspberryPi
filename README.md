...
---
### [x] robot 2 / added camera, grippers
...
x steppers	(4) Stepper Motor 28BYJ48
x control	(4) ULN2003 Driver Board
...
---
### [x] robot 1 / travel control via SmartPhone
...
* batteries	(4) AA batteries in case (for motors)
